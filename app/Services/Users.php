...
class Users extends BaseModel {
    ...
    protected $fillable = [	"id", "password", "nickname", "email", "birthday", "sex", "created_at", "updated_at",];//指定了可以被批量賦值的欄位(不一定要加)
    //$fillable would give you protection there 防止使用者直接改himl的input欄位造成id跳號，不在$fillable裡但是被create那會ignore, 用在Boards::create()
    
    public $incrementing = false; //primaryKey非自動遞增設為false
     ...
     * @return [bool] [已登入/未登入]
     */
    public static function checkIfLogined(){
