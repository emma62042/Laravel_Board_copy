      	...
      	<div class="row justify-content-md-center">
	        <table class="table table-striped table-bordered col col-md-10 col-lg-6">
		        ...
		        <tr>
		        	<th>暱稱</th>
		        	<td>
		        		<input class="form-control" type="text" name="nickname" placeholder="未輸入將以id為暱稱" value="<?php echo e(isset($userData->nickname) ? $userData->nickname : old('nickname')); ?>">
		        	</td>
		        </tr>
		        <tr>
		        	<th><span style="color:red;">*</span>E-mail</th>
		        	<td>
		        		<input class="form-control" type="text" name="email" value="<?php echo e(isset($userData->email) ? $userData->email : old('email')); ?>" required>
		        	</td>
		        </tr>
		        <tr>
		        	<th>生日</th>
		        	<td>
		        		...
		        		<input id="birtydaypicker" name="birtydaypicker" value="<?php echo e(isset($userData->birthday) ? $userData->birthday : ((old('birtydaypicker') != NULL) ? old('birtydaypicker') : '1995-01-31')); ?>"> 
		        	</td>
		        </tr>
		        <tr>
		        	<th>性別</th>
		        	<td>
		        		<div class="form-check form-check-inline">
		        			<input class="form-check-input" type="radio" name="sex" value="M" <?php echo e((isset($userData->sex) && $userData->sex == "M") ? "checked" : ""); ?>>
							<label class="form-check-label">
								Male
							</label>
		        		</div>
		        		<div class="form-check form-check-inline">
		        			<input class="form-check-input" type="radio" name="sex" value="F" <?php echo e((isset($userData->sex) && $userData->sex == "F") ? "checked" : ""); ?>>
							<label class="form-check-label">
								Female
							</label>
		        		</div>
		...
		$(document).ready(function(){//加在各自的VIEW
        	...
        	$("#signupForm").validate({
            	...
            	rules:{
            		id:{ 
                        remote:{
                            url:"<?php echo e(action('UsersController@checkIdJquery')); ?>",
                            type:"get",
